<script>
import Vuetable from '../../components/vuetable/src/components/Vuetable'
import accounting from 'accounting'
import moment from 'moment'
import VuetablePagination from '../../components/vuetable/src/components/VuetablePagination'
import VuetablePaginationInfo from '../../components/vuetable/src/components/VuetablePaginationInfo'
import FilterBar from '../../components/layout/vuetablecommons/Filterbar.vue'
import Vue from 'vue'
...
export default {
  ...
  render (h) {
    return h(
      'div',
      {
        class: { ui: false, container: false }
      },
      [
        h('filter-bar'),
