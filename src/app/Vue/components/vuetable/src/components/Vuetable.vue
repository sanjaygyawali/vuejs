...
<div v-if="isFixedHeader">
  <div class="table-responsive">
    <table :class="['table', css.tableClass, css.tableHeaderClass]">
    <thead>
      <tr>
  ...
  <div class="table-responsive" :style="{height: tableHeight}">
    <table :class="['table', css.tableClass, css.tableBodyClass]">
      <colgroup>
        <template v-for="(field, fieldIndex) in tableFields">
          <template v-if="field.visible">
            <col
...
<div v-else class="table-responsive">
  <table :class="['table', 'table-striped table-hover', css.tableClass]"> <!-- no fixed header - regular table -->
  <thead>
    <tr>
      <template v-for="(field, fieldIndex) in tableFields">
        <template v-if="field.visible">
